            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5">
                       ...
                       <a href="index.php?action=create" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add New User</span></a>
                 ...
                 foreach($result as $res):  ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?delid=<?=$res->getId()?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
